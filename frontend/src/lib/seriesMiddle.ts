...
1辺が $(a + b)$ の大きな正方形を 1 つ用意します。この中に同じ直角三角形を 4 枚、上の絵のように斜めに配置すると、真ん中にぴったり「**1辺が $c$ の正方形**」が現れます。

**ここで、同じ正方形の面積を「2通り」で数える**——これが証明の心臓部分です。
...
$$\\underbrace{4 \\times \\dfrac{ab}{2}}_{4枚の直角三角形} + \\underbrace{c^2}_{中の正方形} = 2ab + c^2$$
