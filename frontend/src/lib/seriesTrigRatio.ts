  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。やることは同じ「小さな三角形の比を、大きな底辺にうつす」。変わったのは数だけ。",
        },
        {
          layer: 2,
...
export const TR_OBTUSE_SERIES: LearnerSeries = {
  ...
  title: "鈍角への拡張（単位円）",
  subtitle: "数Ⅰ・A 三角比より — 定義を座標に移し、0°〜180°まで $10$ 問。",
  patternId: "TR5",
  unit: "algebra_1",
  revelationLabel: "定義を単位円の座標に移すと、直角三角形が描けない鈍角でも同じ言葉で読める",
  drivingQuestion: "直角三角形が描けない 120° でも、なぜ同じ sin・cos・tan が使える？——半径1の円の上の点の座標として読み替えたとき、角の言葉はどこまで届くか？",
  steps: [
    {
      id: "step1",
      position: 1,
      questionText:
        "単位円上で、角 $\\theta = 60°$ に対応する点 $P$ の **$y$ 座標**（$=\\sin\\theta$）はいくつでしょう？",
      answer: Math.sqrt(3) / 2,
      answerDisplay: "√3/2",
      inputAffordances: ["sqrt"],
      unit: "",
      ...
      hints: [
        {
          layer: 1,
          text: "系列3までの直角三角形の [サイン] を思い出そう。斜辺（半径）を $1$ にすると、向かいは点 $P$ のどの座標と同じになる？ [単位円] の上で高さを見てみよう。",
        },
        {
          layer: 2,
          text: "やることは、半径 $1$ の円周上の点の高さを読むこと。$60°$ の有名角の sin がそのまま $y$。",
        },
        {
          layer: 3,
          text: "$y = \\sin 60° = \\dfrac{\\sqrt{3}}{2}$。**斜辺 $1$ なら、sin は高さそのもの＝座標**——定義が座標に移る入口。",
        },
      ],
      formulaPreview: "sin 60° = y = √3/2",
    ...
    },
    {
      ...
      position: 2,
      questionText:
        "同じ点 $P$（$\\theta = 60°$）の **$x$ 座標**（$=\\cos\\theta$）はいくつでしょう？",
      answer: 1 / 2,
      answerDisplay: "1/2",
      unit: "",
      unknownLabel: "x 座標",
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。同じ点。変わったのは読む座標が $y$ から $x$ へ。",
        },
        {
          layer: 2,
          text: "前題と変わったのは横を読むこと——[コサイン]。",
        },
        {
          layer: 3,
          text: "$x = \\cos 60° = \\dfrac{1}{2}$。",
        },
      ],
    ...
    },
    {
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。直角三角形では描けない境界の角——点 $P$ は $x$ 軸上のどこ？",
        },
        {
          layer: 2,
          text: "前題と変わったのは、角が $0°$ という境界になったこと。高さは？",
        },
        {
          layer: 3,
          text: "$P = (1,0)$ なので $\\sin 0° = 0$。三角形がつぶれていても、座標なら読める。",
        },
      ],
      formulaPreview: "sin 0° = 0",
    },
    {
      id: "step4",
      position: 4,
      questionText:
        "$\\theta = 120°$ のとき、$\\sin\\theta$ はいくつでしょう？",
      answer: Math.sqrt(3) / 2,
      answerDisplay: "√3/2",
      inputAffordances: ["sqrt"],
      unit: "",
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。直角三角形が描けない鈍角——でも円の上の点は置ける。高さは鋭角のときと比べてどう？",
        },
        {
          layer: 2,
          text: "前題と変わったのは、角が第2象限（鈍角）へ入ったこと。$120° = 180°-60°$ の高さは $60°$ と同じ。",
        },
        {
          layer: 3,
          text: "$\\sin 120° = \\sin 60° = \\dfrac{\\sqrt{3}}{2}$（正のまま）。**鈍角でも高さは正——定義を座標に移した質的転換**。",
        },
      ],
      formulaPreview: "sin 120° = √3/2",
      figureMarker: "<<TRIG_UNIT_SEMI>>",
    },
    {
      id: "step5",
      position: 5,
      questionText:
        "$\\theta = 120°$ のとき、$\\cos\\theta$ はいくつでしょう？",
      answer: -1 / 2,
      answerDisplay: "-1/2",
      unit: "",
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。同じ $120°$。変わったのは読むのが横（$x$）——符号に注意。",
        },
        {
          layer: 2,
          text: "前題と変わったのは cos。第2象限では $x$ は負。",
        },
        {
          layer: 3,
          text: "$\\cos 120° = -\\dfrac{1}{2}$。鋭角の表をそのまま貼ると符号が壊れる。",
        },
      ],
      formulaPreview: "cos 120° = -1/2",
    },
    {
      id: "step6",
      position: 6,
      questionText:
        "$\\theta = 135°$ のとき、$\\tan\\theta$（直線 $OP$ の傾き）はいくつでしょう？",
      answer: -1,
      answerDisplay: "-1",
      unit: "",
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。今度は傾き——[タンジェント]。鈍角では傾きの符号は？",
        },
        {
          layer: 2,
          text: "前題と変わったのは tan。$\\tan = \\dfrac{\\sin}{\\cos}$ で、第2象限は負。",
        },
        {
          layer: 3,
          text: "$\\tan 135° = \\dfrac{1/\\sqrt{2}}{-1/\\sqrt{2}} = -1$。",
        },
      ],
      formulaPreview: "tan 135° = -1",
    },
    {
      id: "step7",
      position: 7,
      questionText:
        "傾き（$\\tan\\theta$）が $-\\sqrt{3}$ で、$0° < \\theta < 180°$ のとき、$\\theta$ は何度でしょう？",
      answer: 120,
      unit: "",
      unknownLabel: "θ（度）",
      variationFromPrevious: "inverse",
      ...
      hints: [
        {
          layer: 1,
          text: "前題までは角から傾き。今度は逆——傾きから角。",
        },
        {
          layer: 2,
          text: "前題と変わったのは向き。鋭角なら $\\tan = \\sqrt{3}$ は $60°$。鈍角側は？",
        },
        {
          layer: 3,
          text: "参照角 $60°$ の第2象限なので $\\theta = 180°-60° = 120$。",
        },
      ],
      formulaPreview: "tan θ = -√3 → θ = 120°",
    },
    {
      id: "step8",
      position: 8,
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。$150° = 180°-30°$——sin は鋭角側と同じ。",
        },
        {
          layer: 2,
          text: "前題と変わったのは角。高さは $30°$ と同じ。",
        },
        {
          layer: 3,
          text: "$\\sin 150° = \\sin 30° = \\dfrac{1}{2}$。",
        },
      ],
      formulaPreview: "sin 150° = 1/2",
    },
    {
      id: "step9",
      position: 9,
      questionText:
        "$\\cos 150°$ の値はいくつでしょう？——鋭角の表の $\\cos 30°$ をそのまま書くとどうなる？",
      answer: -Math.sqrt(3) / 2,
      answerDisplay: "-√3/2",
      inputAffordances: ["sqrt"],
      unit: "",
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。同じ $150°$。素朴に鋭角の表を貼ると符号が壊れる——座標で読むと？",
        },
        {
          layer: 2,
          text: "前題と変わったのは cos。第2象限の $x$ は負。$\\cos 30°$ の絶対値にマイナス。",
        },
        {
          layer: 3,
          text: "$\\cos 150° = -\\dfrac{\\sqrt{3}}{2}$。**鋭角の表の貼り付けでは解けない——座標読みが必然**。",
        },
      ],
      formulaPreview: "cos 150° = -√3/2",
      figureMarker: "<<TRIG_UNIT_SEMI>>",
    },
    {
      id: "step10",
      position: 10,
      questionText:
        "2辺が $4$ と $6$、挟む角 $120°$ の三角形の面積はいくつでしょう？（系列4の面積公式＋鈍角の sin）",
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。座標で読んだ鈍角の sin（正）を、系列4の面積公式に入れる合流。",
        },
        {
          layer: 2,
          text: "前題と変わったのは、三角比の値を面積に使うこと。$\\sin 120° = \\dfrac{\\sqrt{3}}{2}$。",
        },
        {
          layer: 3,
          text: "$S = \\dfrac{1}{2}\\cdot4\\cdot6\\cdot\\dfrac{\\sqrt{3}}{2} = 6\\sqrt{3}$。鈍角でも sin は正なので面積公式はそのまま。",
        },
      ],
      formulaPreview: "S = 12 · sin120° = 6√3",
    },
  ],
  derivation: `**中心の問い** ｜ 120° でもなぜ同じ三角比が使える？
...
$\\sin\\theta$＝$y$、$\\cos\\theta$＝$x$、$\\tan\\theta$＝傾き。数Ⅱの [一般角]・[単位円] へ続く下側。
