...
export const GEO_CEVA_SERIES: LearnerSeries = {
  ...
  steps: [
    ...
    },
    {
      ...
      position: 10,
      questionText:
        "三角形 $ABC$ で $AB = 3$、$BC = 5$、$CA = 4$ です。$3$ つの角 $A$・$B$・$C$ の [角の二等分線] が、それぞれ向かいの辺 $BC$・$CA$・$AB$ と交わる点を $D$・$E$・$F$ とします。このうち $\\dfrac{AF}{FB}$ の値はいくつでしょう？（既約分数で。$3$ つの比を全部書いて、一周の積が $1$ になることも確かめてみてください）",
      answer: 4 / 5,
      answerDisplay: "4/5",
      unit: "",
      ...
      hints: [
        {
          layer: 1,
          text: "step7 では中線 $3$ 本で一周が $1$ になった。今度は、系列 $1$ で学んだ [角の二等分線] を $3$ 本引く。ただし今度きかれているのは一周の積ではなく、その中の $1$ つ。系列 $1$ で身につけた見方は、ここで部品として使えるだろうか？",
        },
        {
          layer: 2,
