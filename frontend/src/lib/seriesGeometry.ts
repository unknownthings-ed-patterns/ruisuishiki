  ...
  steps: [
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "見るのは、平行線が入ったときの $2$ 辺。平行線があるとき、$2$ 辺の切られ方はどう結びつくか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは「平行線の代わりに、角を半分に切る線が引かれている」こと $1$ つ。前題では平行線が比を運んでくれた。いま与えられているのは角だけ——その角は、辺のどこかに比を残していないだろうか？",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、未知の場所が比から辺 $AB$ に移ったこと。$BP : PC$ は、となりのどの $2$ 辺の比と同じか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは「内角 → 外角」の $1$ 点だけ。外角の二等分線が切る比は、内角のときと何が同じで、分点の位置は何が違うか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "増えたのは「底辺の比 → 面積の比」への乗り換えだけ。頂点が共通で底辺が同じ直線上なら、面積の比は何の比か。",
        },
        {
          layer: 3,
  ...
  steps: [
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "着目するのは底辺だけ。頂点 $A$ が共通で底辺が同じ直線上にあるので、$2$ つの三角形の高さは共通。高さが同じ $2$ つの三角形で、面積の比は何の比と同じか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、切られている辺が $1$ 本から $3$ 本ぶんに増えたこと $1$ つ。$3$ つの比は、それぞれ勝手な値を取れるだろうか。頂点 $A$ から $F・B・D・C・E$ と辺づたいに一周して戻ってくると、何が起きている？",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。一周して戻ってくる、という見方は同じ。変わったのは与えられた $2$ つの比の数だけ。前題で効いた道は、数が変わってもそのまま通るだろうか？",
        },
        {
          layer: 2,
          text: "前題と変わったのは辺の切られ方の数値だけ。一周した比の積はいくつに戻るか。分かっている辺を入れて、残りはどう出すか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、未知が真ん中の $BD : DC$ に移ったこと。一周した比の積はいくつに戻るか。空いている場所が変わっても、残りはどう出すか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、未知が『交わるための条件』になったこと。一周した比の積はいくつに戻るか。分かっている辺を入れて、残りはどう出すか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、$3$ 辺すべてが中点で切られていること。中点 $3$ つなら、一周の各辺の比はどうなるか。その積は？",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      position: 10,
      questionText:
        "三角形 $ABC$ で $AB = 3$、$BC = 5$、$CA = 4$ です。$3$ つの角 $A$・$B$・$C$ の [角の二等分線] が、それぞれ向かいの辺 $BC$・$CA$・$AB$ と交わる点を $D$・$E$・$F$ とします。このうち $\\dfrac{AF}{FB}$ の値はいくつでしょう？（既約分数で。$3$ つの比を全部書いて、一周の積が $1$ になることも確かめてみよう）",
      answer: 4 / 5,
      answerDisplay: "4/5",
      unit: "",
      unknownLabel: "AF/FB の値",
      variationFromPrevious: "composite",
      compareWithStepId: "step9",
      hints: [
        {
          layer: 1,
          text: "step7 では中線 $3$ 本で一周が $1$ になった。今度は、系列 $1$ で学んだ [角の二等分線] を $3$ 本引く。ただし今度聞かれているのは一周の積ではなく、その中の $1$ つ。系列 $1$ で身につけた見方は、ここで部品として使えるだろうか？",
        },
        {
          layer: 2,
          text: "前題と変わったのは、$3$ つの比が [角の二等分線] の性質で決まること $1$ つ。$AF$ と $FB$ を切り分けているのは、$3$ 本のうちどの二等分線だろう。そして系列 $1$ では、二等分線が向かいの辺を切る比を決めていたのは——その頂点の **となりの $2$ 辺** でした。ここではどの $2$ 辺にあたる？",
        },
        {
          layer: 3,
          text: "$AF$ と $FB$ を切っているのは頂点 $C$ の二等分線。系列 $1$ の [角の二等分線] の性質より、それは向かいの辺 $AB$ を **となりの $2$ 辺の比** に切るので $AF : FB = CA : CB = 4 : 5$、つまり $\\dfrac{AF}{FB} = \\dfrac{4}{5}$。\n\n残り $2$ つも同じように書けます：頂点 $A$ → $BD : DC = AB : AC = 3 : 4$、頂点 $B$ → $CE : EA = BC : BA = 5 : 3$。一周の積は $\\dfrac{4}{5} \\cdot \\dfrac{3}{4} \\cdot \\dfrac{5}{3} = 1$ ——**分子と分母が順ぐりに約分されて、辺の長さが何であっても必ず $1$ に戻る**。だから角の二等分線 $3$ 本も必ず $1$ 点で交わり、その点が内心です。\n\n中心の問いに引きつければ——一周の縛りは、線が交わることを **保証する側** にも使える。ここでは系列 $1$ の道具が $3$ つの比を書き、この系列の道具がその比たちを $1$ 本の式で縛りました。",
        },
      ],
      formulaPreview: "頂点 C の二等分線 → AF:FB = CA:CB = 4:5 → 4/5（一周の積 4/5·3/4·5/3 = 1 で検算）",
    },
  ],
  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは $\\angle A$ の値だけ。中心角と頂点の角は、何倍の関係だったか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、角の二等分線から中線への乗り換え。重心は中線を、頂点側と中点側でどちらが長い比に分けるか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      position: 10,
      questionText:
        "三角形 $ABC$ の外心 $O$ は、三角形の **内部** にあります。$\\angle BOC = 76°$ のとき、内心を $I$ として $\\angle BIC$ は何度でしょう？",
      answer: 109,
      unit: "",
      unknownLabel: "∠BIC（度）",
      variationFromPrevious: "composite",
      ...
      hints: [
        {
          layer: 1,
          text: "この系列では $\\angle A$ が与えられて、そこから外心の角（step2〜3）と内心の角（step4〜5）をそれぞれ出してきた。今度は、その $\\angle A$ が書かれていない。代わりに与えられているのは外心の角のほう——これまで通ってきた道は、逆向きにも歩けるだろうか？",
        },
        {
          layer: 2,
          text: "前の step たちと変わったのは、出発点が $\\angle A$ から外心の角に移ったこと $1$ つ。外心の角も内心の角も、もとをたどれば同じ $\\angle A$ ひとつから決まっていた。ということは、$2$ つの角のあいだには、$\\angle A$ を経由する道があるはず。",
        },
        {
          layer: 3,
          text: "$\\angle BOC = 2\\angle A$ だったので、$76 = 2\\angle A$ から $\\angle A = 38$。そこから $\\angle BIC = 90 + \\dfrac{38}{2} = 109$ 度。\n\n**「$O$ は内部にある」の一句が効いている**——これが無いと、$\\angle A = 142°$ の三角形でも $\\angle BOC$ は $76°$ になり（このとき外心は三角形の外に出る）、$\\angle BIC = 161°$ で答えが $2$ つに割れる。\n\nそしてこの $1$ 問がしていたのは、**住所の乗り換え**です。外心は「$3$ 頂点から等距離」→ 垂直二等分線の交点、内心は「$3$ 辺から等距離」→ 角の二等分線の交点。同じ「等距離」でも、**何からの距離か**で引く線が変わり、できる中心が変わる。名前を覚えるのではなく言い換えを乗り換えられること——それが五心を歩く力そのものでした。\n\nちなみに $\\angle A = 60°$ のとき $2\\angle A$ と $90 + \\dfrac{\\angle A}{2}$ は等しくなり、そのとき $B$, $C$, $O$, $I$ は $1$ つの円の上に並びます（同じ辺 $BC$ を同じ角で見込むから）。この「$4$ 点が同じ円に乗る」判定が、次の系列（円周角と中心角）の入口になります。",
        },
      ],
      formulaPreview: "∠BOC = 2∠A → ∠A = 38 → ∠BIC = 90 + 19 = 109",
    },
  ],
  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        {
          layer: 1,
          text: "前題と比べてみよう。中心から見た角と、円周から見た角の関係は同じ。変わったのは中心角の大きさだけ——前題と同じ道がそのまま使える？",
        },
        {
          layer: 2,
          text: "前題と変わったのは中心角が $58$ 度になったこと。中心角から円周角へは、どう写すか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        {
          layer: 1,
          text: "前題までは弧 $AB$ がいろいろな大きさだった。今度は弦 $AB$ が円の直径——$A$ と $B$ が円のちょうど反対側にある特別な場合。前題まで効いてきた見方は、この特別な場合でもそのまま効くだろうか？",
        },
        {
          layer: 2,
    ...
    },
    {
      ...
      position: 10,
      questionText:
        "三角形 $ABC$ の外心を $O$ とします。外心は $3$ 頂点から等距離で $OA = OB = OC$ です。$\\angle OBC = 32$ 度で、点 $A$ は弧 $BC$ の **大きい方**（優弧）の上にあるとき、円周角 $\\angle BAC$ は何度でしょう？",
      answer: 58,
      unit: "",
  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、注目する対角のペアが $A,C$ から $B,D$ に移ったこと。向かい合う組が入れかわっても、和の決まりは同じか。",
        },
        {
          layer: 3,
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 2,
          text: "前題と変わったのは、なす角が $64°$ から $46°$ になったこと。接線と弦のなす角と、反対側の円周角は、どんな関係か。",
        },
        {
          layer: 3,
...
対角の和が $180°$ なのは、向かい合う $2$ つの角が**弧を分担して円を一周ぶん見込む**から。そして四角形の頂点を接点まで滑らせる連続変形をたどると、その等式は姿を変えて接弦定理になります。定理は丸暗記するものではなく、$1$ つの景色（弧が角を決める・頂点を動かしても等式は生き残る）から生やす手つき——だから忘れても、弧の一周と極限の一歩から再建できます。この連続変形の目は、次の「方べきの定理」で、点と円のあいだに潜む不変量へと受け継がれます。`,
};
