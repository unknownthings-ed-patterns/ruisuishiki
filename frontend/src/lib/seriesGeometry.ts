  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        ...
        {
          layer: 3,
          text: "三角形 $ABC$ の内角の和から $\\angle ACB = 180° - 38° - 97° = 45°$。接弦定理より、接線と弦 $AB$ のなす角 $= \\angle ACB = 45°$。接線の角は円周角の定理**だけ**では絶対に結べず、接弦定理が唯一の橋になる——この $1$ 問が、接弦定理が「あると便利」ではなく「なければ届かない」道具だと分かる山場。",
        },
      ],
      formulaPreview:
