  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        ...
        { layer: 3, text: "$x^2 + 5x = (x + \\dfrac{5}{2})^2 - (\\dfrac{5}{2})^2$。頂点の $x$ は $-\\dfrac{5}{2}$。暗記の符号ミスが効く配置——**平方完成の手つきでしか安定しない**。ここを落とすと符号ミスで必ず外れる。" },
      ],
  ...
  steps: [
    ...
    },
    {
      ...
      hints: [
        ...
        { layer: 3, text: "頂点は外。軸に近い端は $x = 3$ で $y = 1 - 5 = -4$。**同じ式でも窓が変われば答えが変わる**——「同じ関数なら答えも同じ」は通じない。" },
      ],
    ...
    },
    {
      ...
      hints: [
        ...
        { layer: 3, text: "頂点 $(1, -4)$ は変域内。最小は $-4$。端点は $x=-2$ で $y=5$、$x=3$ で $y=0$——どちらも頂点より大きい。**端点の $y$ だけ比べると必ず外れる——頂点が窓の中にいないかを先に見る**。" },
      ],
...
**よくある誤り**：端点が常に最小だと思うこと。同じ関数なら答えは同じだと思うこと。
