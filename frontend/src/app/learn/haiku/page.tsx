...
> = {
  ...
  kokugo_shi_me_01: {
    ...
    citation: {
      ...
      note: "— 「風景　純銀もざいく」の本文は、青空文庫版と突き合わせて確かめました。内田麟太郎さんの目で見て楽しむ詩は、詩集『うみがわらっている』（銀の鈴社）などで会えます——としょかんで さがしてみてね。「白鳥のお散歩」の数え上げの形は、同詩集所収の「はるのいけ」に学んだ本歌取です。",
    },
  },
  ...
  kokugo_shi_nazo_01: {
    ...
    citation: {
      ...
      note: "— 「見える見えるなぞなぞ遊び」という詩のつくり方は、白谷明美さんのこの本にある「ひゆ遊び」に学びました。",
    },
  },
  ...
  kokugo_shi_owarai_01: {
    ...
    citation: {
      ...
      note: "— 「一口お笑い」という詩のつくり方は、白谷明美さんのこの本にあります。",
    },
  },
  ...
  kokugo_shi_yume_01: {
    ...
    citation: {
      ...
      note: "— 「〜のゆめ」という詩のつくり方（イメージ遊び）は、白谷明美さんのこの本にあります。この遊びのお手本になった、くどうなおこさんの「のはらうた」のかたつむりのゆめの詩は——としょかんで さがしてみてね。",
    },
  },
  ...
  kokugo_shi_kakeai_01: {
    ...
    citation: {
      ...
      note: "— 「ようすことば」「二人でかけ合い」という詩のつくり方は、白谷明美さんのこの本にあります。「兎の電報」は北原白秋の詩で、本文は、白谷さんの本に転載された、北原白秋生家保存会『北原白秋のうたの絵本』掲載版に拠りました（いちばん古い出どころの『白秋童謡集 第2集』は、国立国会図書館デジタルコレクションで館内限定の公開なので、書名だけを確かめています）。",
    },
  },
  ...
  kokugo_shi_heya_01: {
    ...
    citation: {
      ...
      note: "— 「6つのへやの詩」という詩のつくり方（Six-Room Poem）は、アメリカの詩人で先生のジョージア・ハードさんが考えたものです。日本語のワークシートにしたのは岩井輝久で、このページに出てくるワークシートと「犬のペペ」（書き直す前の版・書き直したあとの版）は、どちらも岩井輝久が書いたものです。Step5 の「くりかえしを縮めた版」は、読みくらべのためにキーワードの行だけを縮めたものです（もとの詩は、三回くりかえすほうです）。",
    },
  },
    ...
    citation: {
      apa: (
        <>
          ...
          {". アリス館.（冒頭の詩が型の原典）／あすこま（2025）「今年の授業開き単元は「好きリスト」。その思わぬ効用とは？」askoma.info（2025年5月8日）."}
        </>
      ),
      note: "— 「好きリスト」という詩のつくり方は、谷川俊太郎さんの『すき好きノート』のいちばんはじめにある詩から来ています——としょかんで さがしてみてね。この遊びを教室の実践にしたのは国語の先生の甲斐利恵子さんで、それを追試してブログで紹介したのが、作文教育を研究する国語の先生のあすこまさんです（上のリンクがその記事です）。",
    },
  },
  kokugo_hanashi_moshi_01: {
    ...
    citation: {
      ...
      note: "— 「おくさまの部屋」「七番めの王女」は、あらすじと急所の場面だけを載せています。英語の原文は、上のリンク先で読めます。",
    },
  },
  ...
  kokugo_hanashi_nikoushiki_01: {
    ...
    citation: {
      ...
      note: "— 「二つのことばが出会うと」というお話のつくり方（ファンタジーの二項式）は、イタリアの作家ジャンニ・ロダーリさんが『ファンタジーの文法』に書いたものです——としょかんで さがしてみてね。日本の教室では、村田栄一さんの『ことばのびっくりばこ』と、田丸雅智さんの『超ショートショート講座』が同じ型を受けついでいます。「りんと金の魚」は、岩瀬直樹さんの「ウソの詩を書こう」の実践に学んで、岩井輝久が散文のお話として書き下ろしたものです。",
    },
  },
  ...
  kokugo_hanashi_parody_01: {
    ...
    citation: {
      ...
      note: "— 「書き換え（パロディ作文）」というお話のつくり方は、三藤恭弘さんが『「物語の創作/お話づくり」のカリキュラム30』で授業にしたものです——としょかんで さがしてみてね。その源流は、ロシアのプロップさんが『昔話の形態学』で見つけた31の機能で、イタリアのロダーリさんの『ファンタジーの文法』22章「プロップのカード」を通って、日本の教室に届きました。「昔話の骨の図鑑」は、その31を、この教室のことばで自前に言いなおしたものです。「桃太郎」は、青空文庫の楠山正雄版を底本にして、岩井輝久が低中学年向けに縮約して再話しました（オノマトペの「ぺんたらこっこ」は岩井の創作です）。上のリンクから、再話の元になった、もっと長くて豊かな全文が読めます。",
    },
  },
    ...
    citation: {
      apa: (
        <>
          ...
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". Oxford University Press.（あらすじ＝要約・訳は本系列のための自前訳）／英語原文＝Gutenberg Canada."}
        </>
      ),
      note: "— 「七番めのひめ」で載せているのは、あらすじ（設計者が自分のことばで書いた要約）と、急所の場面二つ（名づけの日のおくりもの・かみをはかる場面）だけです。訳は、上のリンクの英語原文（Gutenberg Canada 版）からの自前訳で、既存の邦訳（石井桃子ほか訳・岩波）は参照していません。原文にある Gypsy という語は、現代の出版慣例に合わせて「たびの民のむすめ」と言い換えました。",
    },
  },
  ...
  kokugo_hanashi_settei_01: {
    ...
    citation: {
      ...
      note: "— 「人物を分けてならべる」というお話のつくり方は、イタリアのロダーリさんが『ファンタジーの文法』25章「ベファーナの分析」で書いたものです——としょかんで さがしてみてね。日本で同じ型を授業にしたのは、三藤恭弘さんの『「物語の創作/お話づくり」のカリキュラム30』単元18です。",
    },
  },
  ...
  kokugo_nikki_slow_01: {
    ...
    citation: {
      ...
      note: "— 「5びょう日記」という書き方は古賀及子さんが見つけたもので、「作家の風景」の一文は同書まえがき・紹介文からの引用です。系列①の手本（ぎょうざ日記）は、光村図書2年「日記を書こう」の構成を借りています。",
    },
  },
    ...
    citation: {
      apa: (
        <>
          ...
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". 素粒社.（直書きの系譜）／石丸恵彦・向坂くじら・澤田英輔・森大徳（編）（2025）"}
          <i>語感を磨くレトリック選 中高生のための表現読本</i>
          {". 筑摩書房.（採録と「五分間」の手引き）／中島礼子・今井成司（編著）（2011）"}
          <i>楽しい随筆の授業</i>
          {"（作文シリーズ3）. 日本標準.（（　）の系譜）."}
        </>
      ),
      note: "— 心の中のことばを（　）に入れずに、そのまま流して書く書き方は、日記の名人の古賀及子さんが日記の本で書きつづけてきたものです（日記の系列②の「5びょう日記」と、おなじ人です）——としょかんで さがしてみてね。古賀さんの日記も選ばれて入っているのが『語感を磨くレトリック選 中高生のための表現読本』です。Step7 の「五分間、だいじかどうかを決めずに手を動かす」は、この本にのっている練習の手つきを借りたものです（編者のひとり澤田英輔さんは、詩の系列「好きリスト」で名前が出てきた「あすこま」さんと、同じ先生です）。心の中のことばを（　）で書き分ける側の系譜は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「ぺぺちゃんがほえた」と「浜なしを買えた！！」は岩井輝久が書いた日記です——「浜なし」のほうは、校長先生の名前と勤務校を、本人の指定で仮名（Ｉ校長・Ａ小学校）にしてあります。表記のゆれ（わたし／僕・看板／カンバン）は、実物の尊重のため原文のままです。犬の名前は、詩の系列では「ペペ」、日記では「ぺぺ」——どちらも、岩井さんが書いたときのままです。Step4 の（　）を外した一文は、この読みくらべのために記号だけを外した版です。",
    },
  },
  ...
  kokugo_zuihitsu_mitsuke_01: {
    ...
    citation: {
      ...
      note: "— 『柿の種』の短章の本文は、青空文庫『柿の種』（底本＝岩波文庫1996年版）と突き合わせて、一字も変わっていないことを確認しました。随筆とは何かという説明と、単元の組み立ては、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「いつもの八百屋で」は岩井輝久が書いた一編で、日記の系列②と同じ文章を、随筆の目で読み直しています。",
    },
  },
    ...
    citation: {
      apa: (
        <>
          ...
          Writing</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". Heinemann.（型の原典）／中島礼子・今井成司（編著）（2011）"}
          <i>楽しい随筆の授業</i>
          {"（作文シリーズ3）. 日本標準.（随筆の評の観点の参考）／清少納言『枕草子』「うつくしきもの」（十一世紀初め・もっと読む・訳は自前）."}
        </>
      ),
      note: "— 「たからものリスト」のもとになった「ハートマップ（心の地図）」は、アメリカの詩人で先生のジョージア・ハードさんが考えたものです（詩の「6つのへやの詩」と、おなじ人の発明です）。もとの本は英語で書かれた、先生むけの本です。随筆をどう読むかという観点は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「たからものリスト」と「ぷちにゃ」は岩井輝久が書いたもので、「ぷちにゃさん」は本文の中で作者自身が仮の名にしています。表記のゆれ（石巻／石まき・ウェットスーツ／スウェットスーツ）も、実物の尊重のため原文のままにしてあります。『枕草子』の「うつくしきもの」は、清少納言が千年前に書いたもので、原文（抜粋）を載せ、現代のことばへの訳は、この教室のための自前訳です——『枕草子』は、としょかんで さがしてみてね。",
    },
  },
    ...
    citation: {
      apa: (
        <>
          ...
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {"（作文シリーズ3）. 日本標準.（「」と（　）の記述指導・声の様子の観点の参考）／岩井の教室の実践（蚕二篇＝理科の授業のために蚕を育てた実話）."}
        </>
      ),
      note: "— 言ったことは「」で、心の中のつぶやきは（　）で書き分けるという教え方と、どんなふうに言ったか（声の様子）まで見るという読み方は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「言っていたこととちがうじゃないか！！」と「たまごから蚕を育てたよ」は岩井輝久が書いたもので、理科の授業のために蚕を育てたときの実話です。文中の名前や場所は、作者本人が書き直してぼかしてあります。表記のゆれ（ひと安心／一安心・博物館／はくぶつかん）は、実物の尊重のため原文のままにしてあります。",
    },
  },
    ...
    citation: {
      apa: (
        <>
          中島礼子・今井成司（編著）（2011）<i>楽しい随筆の授業</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {"（作文シリーズ3）. 日本標準.（「揺れ動く心を書く」「心の変化は出来事・事実との関連で書く」「事実だけを書いて気持ちを書かない」の観点の出典）／岩井「Ｕさんの思い出」＝実話（実名は仮名化）."}
        </>
      ),
      note: "— 心のゆれ（揺れ動く心）を書くこと、心の変化は出来事・事実とのつながりのなかで書くこと、そして事実だけを書いて気持ちを書かない一文がいちばん深く感じさせることがある——この三つの読み方は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「Ｕさんの思い出」は岩井輝久が書いた19才のころの実話で、先ぱいの名前は本人の裁定で仮名（Ｕさん）にしてあります。文中の平川祐弘さんは実在の翻訳家です。この一篇は、随筆の系列②で読んだ「たからものリスト」の三番目「プレゼントしてもらった、ダンテの『神曲』」の来歴にあたります。",
    },
  },
};
