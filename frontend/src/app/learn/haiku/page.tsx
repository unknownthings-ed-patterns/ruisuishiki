...
> = {
  ...
  kokugo_shi_nazo_01: {
    ...
    citation: {
      ...
      note: "— 「見える見えるなぞなぞ遊び」という詩のつくり方は、白谷明美さんのこの本にある「ひゆ遊び」に学びました。遊び方（アイデア）は借りてよいものですが、本にのっている詩そのものは著作権で守られているので、このページには載せていません（書名だけです）。この系列に出てくる問題の詩は、先生の教室の子どもたちの詩の組み立てに学んで、場面もことばもこちらで書き下ろした自作です（子どもたちの詩の本文は使っていません）。「見える見えるなぞなぞ」（スプーン）は岩井輝久の自筆で、本人の許諾つきです。",
    },
  },
  ...
  kokugo_shi_owarai_01: {
    ...
    citation: {
      ...
      note: "— 「一口お笑い」という詩のつくり方は、白谷明美さんのこの本にあります。遊び方（アイデア）は借りてよいものですが、本にのっている詩そのものは著作権で守られているので、このページには載せていません（書名だけです）。この系列に出てくる問題の詩は、本の作例と、先生の教室の子どもたちの詩の組み立てに学んで、そろえる音も場面もこちらで書き下ろした自作です（本や子どもたちの詩の本文は使っていません）。「とって」は岩井輝久の自筆で、本人の許諾つきです。",
    },
  },
