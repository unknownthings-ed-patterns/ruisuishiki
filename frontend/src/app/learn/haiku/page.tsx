...
> = {
    ...
    citation: {
      apa: (
        <>
          ...
          {". アリス館.（冒頭の詩「好きリスト」が型の原典）／あすこま（2025）「今年の授業開き単元は「好きリスト」。その思わぬ効用とは？」askoma.info（2025年5月8日）."}
        </>
      ),
  ...
  kokugo_nikki_omoumama_01: {
    ...
    citation: {
      ...
      note: "— 心の中のことばを（　）に入れずに、そのまま流して書く書き方は、日記の名人の古賀及子さんが日記の本で書きつづけてきたものです（日記の系列②の「5びょう日記」と、おなじ人です）——としょかんで さがしてみてね。古賀さんの日記を選んで一冊にしたのが『語感を磨くレトリック選 中高生のための表現読本』です。Step7 の「五分間、だいじかどうかを決めずに手を動かす」は、この本にのっている練習の手つきを借りたものです（編者のひとり澤田英輔さんは、詩の系列「好きリスト」で名前が出てきた「あすこま」さんと、同じ先生です）。心の中のことばを（　）で書き分ける側の系譜は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「ぺぺちゃんがほえた」と「浜なしを買えた！！」は岩井輝久が書いた日記です——「浜なし」のほうは、校長先生の名前と勤務校を、本人の指定で仮名（Ｉ校長・Ａ小学校）にしてあります。表記のゆれ（わたし／僕・看板／カンバン）は、実物の尊重のため原文のままです。Step4 の（　）を外した一文は、この読みくらべのために記号だけを外した版です。",
    },
  },
  ...
  kokugo_zuihitsu_takara_01: {
    ...
    citation: {
      ...
      note: "— 「たからものリスト」のもとになった「ハートマップ（心の地図）」は、アメリカの詩人で先生のジョージア・ハードさんが考えたものです（詩の「6つのへやの詩」と、おなじ人の発明です）——としょかんで さがしてみてね。随筆をどう読むかという観点は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。「たからものリスト」と「ぷちにゃ」は岩井輝久が書いたもので、「ぷちにゃさん」は本文の中で作者自身が仮の名にしています。表記のゆれ（石巻／石まき・ウェットスーツ／スウェットスーツ）も、実物の尊重のため原文のままにしてあります（リストのほうは、カセットテープの行の開き括弧だけを、作者の裁定でカットしました）。『枕草子』の「うつくしきもの」は、清少納言が千年前に書いたもので、原文（抜粋）を載せ、現代のことばへの訳は、この教室のために自前で作りました（既存の訳は参照していません）。",
    },
  },
