...
/**
 * このプレイヤーが歩ける国語系列の全部（俳句3＋詩8＋お話5＋日記3＋随筆4）。
...
> = {
  ...
  // 詩系列⑧「好きリスト」。型の原典（谷川俊太郎『すき好きノート』冒頭の詩）は保護中なので
  // **本文非掲載・書誌のみ**（2026-08-22 裁定3）。実践の系譜（甲斐利恵子さんの実践→
  // あすこまさんの追試）は、記事への外部リンクを japanese に置く（裁定4。外部リンクは
  // 詩①の poets.org・お話①の Gutenberg Canada に続く3例目。生存確認済み 2026-08-22）。
  // 教え子の作品4点は本文非掲載（裁定6）。english は空（見出しごと出ない）。
  kokugo_shi_suki_01: {
    english: [],
    japanese: [
      {
        href: "https://askoma.info/2025/05/08/10735",
        label:
          "今年の授業開き単元は「好きリスト」。その思わぬ効用とは？（あすこまさんのブログ）",
        note: "この系列の実践の出どころ。甲斐利恵子さんの実践を、あすこまさんが追試して紹介した記事",
      },
    ],
    citation: {
      apa: (
        <>
          谷川俊太郎（2012）<i>すき好きノート</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". アリス館.（冒頭の詩「好きリスト」が型の原典・本文非掲載・書誌のみ）／あすこま（2025）「今年の授業開き単元は「好きリスト」。その思わぬ効用とは？」askoma.info（2025年5月8日）."}
        </>
      ),
      note: "— 「好きリスト」という詩のつくり方は、谷川俊太郎さんの『すき好きノート』のいちばんはじめにある詩から来ています。つくり方（アイデア）は借りてよいものですが、谷川さんの詩そのものは、いまも著作権で守られているので、このページには本文をいっさい載せていません（書名だけです）——としょかんで さがしてみてね。この遊びを教室の実践にしたのは国語の先生の甲斐利恵子さんで、それを追試してブログで紹介したのが、作文教育を研究する国語の先生のあすこまさんです（上のリンクがその記事です）。「好きリスト」は岩井輝久の自筆で、本人の許諾つきです——文中の固有名は、すべて事実の言及です。この系列に出てくるほかのリスト（つりの三行・ねこの二つ・夏の三行）は、この教材のために書き下ろした自作です。岩井の教室の子どもたちの作品は、書き直しの組み立て（ならべる順番・行のおわり・くわしさ）にだけ学んで、本文は載せていません。",
    },
  },
  ...
  // お話系列③「物語の書き換え（パロディ作文）」。土台の「桃太郎」は楠山正雄版（1950年没＝
  // 保護期間満了）を底本にした岩井再話なので全文を載せている。日本語リンクは青空文庫の
  // 楠山版の図書カード1本だけ（再話の元の全文を丸ごと読める場所＝外部リンク5例目・
  // 2026-08-23 生存確認済み）。三藤(2010)は保護中なので本文・18枚のカード・「かぼちゃひめ」
  // 本文は非掲載・書誌のみ。プロップの31機能は理論（アイデア）だけを借りて、訳書の文言は
  // 写さず子ども語で自前に言いなおした（「昔話の骨の図鑑」）。教え子の冊子2冊も本文非掲載
  // （作家の風景で匿名の敬意のみ・裁定8）。外国語の原文は無いので english は空。
  kokugo_hanashi_parody_01: {
    english: [],
    japanese: [
      {
        href: "https://www.aozora.gr.jp/cards/000329/card18376.html",
        label: "楠山正雄「桃太郎」全文（青空文庫）",
        note: "再話の元の、もっと長くて豊かな全文——きじの宙がえりと桜の結びまで",
      },
    ],
    citation: {
      apa: (
        <>
          ウラジーミル・プロップ（1987）<i>昔話の形態学</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". 北岡誠司・福田美智代訳. 水声社.（31の機能の理論）／ジャンニ・ロダーリ（1990）"}
          <i>ファンタジーの文法</i>
          {". 窪田富男訳. 筑摩書房（ちくま文庫）.（22章「プロップのカード」）／三藤恭弘（2010）"}
          <i>
            書く力がぐんぐん身につく「物語の創作/お話づくり」のカリキュラム30——ファンタジーの公式
          </i>
          {". 明治図書.（書き換え・プロップのカードの授業の型）／楠山正雄「桃太郎」青空文庫（底本＝講談社学術文庫・1983）."}
        </>
      ),
      note: "— 「書き換え（パロディ作文）」というお話のつくり方は、三藤恭弘さんが『「物語の創作/お話づくり」のカリキュラム30』で授業にしたものです。つくり方（アイデア）は借りてよいものですが、本の文章と、本にのっている18枚のカードのことばや絵、「かぼちゃひめ」の本文は、このページには載せていません（書名だけです）——としょかんで さがしてみてね。その源流は、ロシアのプロップさんが『昔話の形態学』で見つけた31の機能で、イタリアのロダーリさんの『ファンタジーの文法』22章「プロップのカード」を通って、日本の教室に届きました。「昔話の骨の図鑑」は、その31を、この教室のことばで自前に言いなおしたものです（訳された本の文章は写していません）。「桃太郎」は、楠山正雄さんが1950年に亡くなっていて保護期間が満了しているので、青空文庫の楠山版を底本にして、岩井輝久が低中学年向けに縮約して再話しました（オノマトペの「ぺんたらこっこ」は岩井の創作です）。上のリンクから、再話の元になった、もっと長くて豊かな全文が読めます。「しんじゅひめ」は、この教材のために書き下ろした自作です。岩井の教室の子どもたちの書き換えは、型どおりに置きかえた組み立てと、元の話に無い骨をたして型をやぶった組み立てにだけ学んで、本文は載せていません。",
    },
  },
  // お話系列④「七番めのひめ（そろった六つと、ちがう一つ）」。お話①と同じ引用ベースの
  // 権利規律（あらすじ＝要約は自由・急所2場面は自前訳の部分引用・原文は外部リンクのみ）。
  // english は Gutenberg Canada の1本だけ（お話①と同じ URL を再掲＝The Seventh Princess の
  // 英語原文が読める場所。2026-08-23 生存確認済み）。日本語で読める PD の版は無いので
  // japanese は空（見出しごと出ない）。**原文の Gypsy は「たびの民のむすめ」と言い換えた
  // （2026-08-23 岩井裁定）**ので、その断りを note に明記する。
  kokugo_hanashi_princess_01: {
    english: [
      {
        href: "https://gutenberg.ca/ebooks/farjeone-littlebookroom/farjeone-littlebookroom-00-h.html",
        label:
          "The Seventh Princess 英語原文（The Little Bookroom・Gutenberg Canada）",
        note: "あらすじと訳のもとになった英語の原文——ファージョンさん自身のことばで読める",
      },
    ],
    japanese: [],
    citation: {
      apa: (
        <>
          Farjeon, E. (1955). &quot;The Seventh Princess&quot;. In{" "}
          <i>The Little Bookroom</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". Oxford University Press.（あらすじ＝要約・引用は32条・訳文の引用は47条の6・訳は本系列のための自前訳）／英語原文＝Gutenberg Canada."}
        </>
      ),
      note: "— 「七番めのひめ」は、初出年が確定できず日本では保護中の可能性があるため、全文は載せていません。載せているのは、あらすじ（設計者が自分のことばで書いた要約で、原文の表現は写していません）と、急所の場面二つ（名づけの日のおくりもの・かみをはかる場面）の部分引用だけです（著作権法32条の引用・翻訳しての引用は47条の6）。訳は、上のリンクの英語原文（Gutenberg Canada 版）からの自前訳で、既存の邦訳（石井桃子ほか訳・岩波）は参照していません。原文にある Gypsy という語は、現代の出版慣例に合わせて「たびの民のむすめ」と言い換えました（2026-08-23 岩井裁定）。「六つのパンと、ふくらまなかった一つ」は、この教材のために書き下ろした自作です。",
    },
  },
  // お話系列⑤「登場人物のせっていカード（べファーナの分析）」。方法の系譜（ロダーリ25章・
  // 三藤単元18）は**アイデアなので借りてよい**が、二冊とも保護中なので本文とワークシートは
  // 非掲載・書誌のみ。カードの項目名は同じ職場の先生の様式から**項目だけ**を使っており、
  // 出典行は書かない（項目のみの使用のため出典不要＝2026-08-26 先生裁定。作家の風景の
  // 匿名の一言だけを残す）。教え子の記入例4枚も非掲載。教材（見本カード2枚・ねこペア・
  // 選択肢の素材）はすべて自作。外国語の原文も PD の日本語作品も無いので english/japanese
  // は空（見出しごと出ない）。
  kokugo_hanashi_settei_01: {
    english: [],
    japanese: [],
    citation: {
      apa: (
        <>
          ジャンニ・ロダーリ（1990）<i>ファンタジーの文法</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". 窪田富男訳. 筑摩書房（ちくま文庫）.（25章「ベファーナの分析」＝方法の原典）／三藤恭弘（2010）"}
          <i>
            書く力がぐんぐん身につく「物語の創作/お話づくり」のカリキュラム30——ファンタジーの公式
          </i>
          {". 明治図書.（単元18「ベファーナの分析」＝3つの特徴の器）"}
        </>
      ),
      note: "— 「人物を分けてならべる」というお話のつくり方は、イタリアのロダーリさんが『ファンタジーの文法』25章「ベファーナの分析」で書いたものです。つくり方（アイデア）は借りてよいものですが、本の文章と、本にのっている例は、このページには載せていません（書名だけです）——としょかんで さがしてみてね。日本で同じ型を授業にした三藤恭弘さんの本も、本文もワークシートも載せていません（書名だけです）。この系列に出てくるカード（スミレさんとポン吉）も、ねこの二つのお話も、えらぶ問題の材料も、ぜんぶこの教材のために書き下ろした自作です。岩井の教室の子どもたちが書いたカードは、「じつは」ということばを自分たちで発明したこと——そのことだけを「作家の風景」に書き、カードの本文はいっさい載せていません。",
    },
  },
  ...
  // 日記系列③「思ったことを思ったまま書く」。本歌二篇は岩井の実物（licensed・仮名化ずみ）
  // なので、外部で読める PD 作品も外国語の原文も無い＝english/japanese とも空
  // （見出しごと出ない）。古賀及子は在世＝保護中なので本文も引用も載せず書誌だけ
  // （＝作家の風景では系譜としてだけ語る）。「もっと読む」は初版では置かない。
  kokugo_nikki_omoumama_01: {
    english: [],
    japanese: [],
    citation: {
      apa: (
        <>
          古賀及子（2022）<i>ちょっと踊ったりすぐにかけだす</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". 素粒社.（直書きの系譜・本文非掲載・書誌のみ）／石丸恵彦・向坂くじら・澤田英輔・森大徳（編）（2025）"}
          <i>語感を磨くレトリック選 中高生のための表現読本</i>
          {". 筑摩書房.（採録と「五分間」の手引き・本文非掲載）／中島礼子・今井成司（編著）（2011）"}
          <i>楽しい随筆の授業</i>
          {"（作文シリーズ3）. 日本標準.（（　）の系譜・本文非掲載）."}
        </>
      ),
      note: "— 心の中のことばを（　）に入れずに、そのまま流して書く書き方は、日記の名人の古賀及子さんが日記の本で書きつづけてきたものです（日記の系列②の「5びょう日記」と、おなじ人です）。古賀さんはいまも書いている作家なので、このページには本文をいっさい載せていません（書名だけです）——としょかんで さがしてみてね。古賀さんの日記を選んで一冊にした『語感を磨くレトリック選 中高生のための表現読本』も、本文と手引きの文章は載せていません。Step7 の「五分間、だいじかどうかを決めずに手を動かす」は、この本にのっている練習の手つきだけを借りたものです（編者のひとり澤田英輔さんは、詩の系列「好きリスト」で名前が出てきた「あすこま」さんと、同じ先生です）。心の中のことばを（　）で書き分ける側の系譜は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました（こちらも本文と、本にのっている子どもの作例は載せていません）。「ぺぺちゃんがほえた」と「浜なしを買えた！！」は岩井輝久の自筆で、本人の許諾つきです——「浜なし」のほうは、校長先生の名前と勤務校を、本人の指定で仮名（Ｉ校長・Ａ小学校）にしてあります。表記のゆれ（わたし／僕・看板／カンバン）は、実物の尊重のため原文のままです。Step4 の（　）を外した一文は、この読みくらべのために作者本人の許諾を得て記号だけを外した版です。雨の日の二つの版と、「と思いました」の三つの言いかえは、この教材のために書き下ろした自作です。",
    },
  },
  ...
  // 随筆系列②「たからものリスト（心の地図）」。型の原典（ジョージア・ハードの Heart Maps）
  // は保護中なので、テンプレートの本文も図案も載せず書誌のみ（詩⑦六つのへやと同じ扱い）。
  // 『楽しい随筆の授業』も本文・子どもの作例は非掲載。「もっと読む」の枕草子は原文が PD で、
  // 現代のことばへの訳だけが自前。外部で読める英語原文は無く、枕草子は版によって本文が
  // 分かれるので特定の外部本文にリンクしない＝english/japanese とも空（見出しごと出ない）。
  kokugo_zuihitsu_takara_01: {
    english: [],
    japanese: [],
    citation: {
      apa: (
        <>
          ...
          Writing</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {". Heinemann.（型の原典・テンプレート本文と図案は非掲載）／中島礼子・今井成司（編著）（2011）"}
          <i>楽しい随筆の授業</i>
          {"（作文シリーズ3）. 日本標準.（随筆の評の観点の参考・本文非掲載）／清少納言『枕草子』「うつくしきもの」（十一世紀初め・もっと読む・訳は自前）."}
        </>
      ),
      note: "— 「たからものリスト」のもとになった「ハートマップ（心の地図）」は、アメリカの詩人で先生のジョージア・ハードさんが考えたものです（詩の「6つのへやの詩」と、おなじ人の発明です）。つくり方（アイデア）は借りてよいものですが、本にのっているテンプレートの文章と図案は、このページには載せていません（書名だけです）——としょかんで さがしてみてね。随筆をどう読むかという観点は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びましたが、本の本文と、本にのっている子どもの作例は載せていません。「たからものリスト」と「ぷちにゃ」は岩井輝久の自筆で、本人の許諾つきです——文中の固有名は、すべて事実の言及で、「ぷちにゃさん」は本文の中で作者自身が仮の名にしています。表記のゆれ（石巻／石まき・ウェットスーツ／スウェットスーツ）も、実物の尊重のため原文のままにしてあります（リストのほうは、カセットテープの行の開き括弧だけを、作者の裁定でカットしました）。ビー玉のリストと随筆、グローブの随筆、全部書く版と一つを選んで書く版、セミのぬけがらの文は、この教材のために書き下ろした自作です。『枕草子』の「うつくしきもの」は、清少納言が千年前に書いたもので保護期間はとうに満了しているため原文（抜粋）を載せ、現代のことばへの訳は、この教室のために自前で作りました（既存の訳は参照していません）。",
    },
  },
  // 随筆系列③「その場にいるように（「」と（　））」。本歌も「もっと読む」も岩井の実物
  // （licensed・本人改稿ずみ）なので、外部で読める PD 作品も外国語の原文も無い
  // ＝english/japanese とも空（見出しごと出ない）。『楽しい随筆の授業』は「」と（　）の
  // 記述指導・声の様子の観点を参考にした本で、本文も子どもの作例も載せていない（書誌のみ）。
  kokugo_zuihitsu_sonoba_01: {
    english: [],
    japanese: [],
    citation: {
      apa: (
        <>
          中島礼子・今井成司（編著）（2011）<i>楽しい随筆の授業</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {"（作文シリーズ3）. 日本標準.（「」と（　）の記述指導・声の様子の観点の参考・本文非掲載）／岩井の教室の実践（蚕二篇＝理科の授業のために蚕を育てた実話）."}
        </>
      ),
      note: "— 言ったことは「」で、心の中のつぶやきは（　）で書き分けるという教え方と、どんなふうに言ったか（声の様子）まで見るという読み方は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。考え方（アイデア）は借りてよいものですが、本の本文と、本にのっている子どもの作例は、このページには載せていません（書名だけです）。「言っていたこととちがうじゃないか！！」と「たまごから蚕を育てたよ」は岩井輝久の自筆で、本人の許諾つきです——理科の授業のために蚕を育てたときの実話で、文中の名前や場所は、作者本人が書き直してぼかしてあります。表記のゆれ（ひと安心／一安心・博物館／はくぶつかん）は、実物の尊重のため原文のままにしてあります。じゃんけんの場面と、水とうの二つの版（声だけの版と、心のつぶやきが入った版）、コップの音の三つの続き、図書室の三つの言い方は、この教材のために書き下ろした自作です。",
    },
  },
  // 随筆系列④「ゆれうごく心」。本歌は岩井の実物（licensed・仮名化ずみ）なので、外部で
  // 読める PD 作品も外国語の原文も無い＝english/japanese とも空（見出しごと出ない）。
  // 『楽しい随筆の授業』は「揺れ動く心を書く」「心の変化は出来事・事実との関連で書く」
  // 「事実だけを書いて気持ちを書かない」の評の観点を参考にした本で、本文も子どもの作例も
  // 載せていない（書誌のみ）。「もっと読む」は初版では置かない。
  kokugo_zuihitsu_yure_01: {
    english: [],
    japanese: [],
    citation: {
      apa: (
        <>
          中島礼子・今井成司（編著）（2011）<i>楽しい随筆の授業</i>
          {/* 日本語は行を折らずに1つの文字列で持つ（JSX の改行は空白になるため） */}
          {"（作文シリーズ3）. 日本標準.（「揺れ動く心を書く」「心の変化は出来事・事実との関連で書く」「事実だけを書いて気持ちを書かない」の観点の出典・本文非掲載）／岩井「Ｕさんの思い出」＝実話（実名は仮名化）."}
        </>
      ),
      note: "— 心のゆれ（揺れ動く心）を書くこと、心の変化は出来事・事実とのつながりのなかで書くこと、そして事実だけを書いて気持ちを書かない一文がいちばん深く感じさせることがある——この三つの読み方は、中島礼子さん・今井成司さんたちの『楽しい随筆の授業』に学びました。考え方（アイデア）は借りてよいものですが、本の本文と、本にのっている子どもの作例は、このページには載せていません（書名だけです）。「Ｕさんの思い出」は岩井輝久の自筆で、本人の許諾つきです——19才のころの実話で、先ぱいの名前は本人の裁定で仮名（Ｕさん）にしてあります。文中の平川祐弘さんは実在の翻訳家で、事実の言及です。この一篇は、随筆の系列②で読んだ「たからものリスト」の三番目「プレゼントしてもらった、ダンテの『神曲』」の来歴にあたります。発表の二つの場面、給食の場面、木下さんをさそう二つの版（ならした版と、ゆれのまま版）、どきっとした三つの出来事、うれしさの三つの言いかえは、この教材のために書き下ろした自作です。",
    },
  },
};
